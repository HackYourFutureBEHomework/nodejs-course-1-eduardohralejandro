...
server.get('/send/:email', (request, response)=>{
    ...
    auth: {
        ...
        pass: 'eduardo1234' //I will change this password after this class, don't worry  
    },
    tls:{
...
server.get('*', (request, response) => {
    response.send('oh! it seems that you are in the wrong place, under 18 are not allowed, try again kid')
})
